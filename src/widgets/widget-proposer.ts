...
const SYSTEM = [
  ...
  '- Carte soignée : coins arrondis, un joli fond (dégradé ou couleur douce), un peu de padding.',
  '- Thème clair par DÉFAUT (texte sombre, fond clair) ET une variante sombre déclenchée par',
  "  l'attribut hôte : `:root[data-cbw-theme=\"dark\"] .cbw-<type>{…}` (texte clair, fond sombre).",
  '  N\'utilise PAS @media (prefers-color-scheme) — le thème est piloté par l\'attribut.',
