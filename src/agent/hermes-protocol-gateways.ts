...
const CAPABILITIES: HermesProtocolGatewayCapability[] = [
  ...
  },
  {
    ...
    notes: [
      'The stdio ACP transport supports initialize, session/new, in-process session/load replay, session/prompt, session/cancel, and agent-to-client JSON-RPC request/response correlation.',
