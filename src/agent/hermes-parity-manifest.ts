...
const FEATURES: HermesParityFeature[] = [
  ...
  },
  {
    ...
    notes: 'Channel coverage is broad, gateway readiness is machine-readable in CLI and Cowork, send_message exists with dry-run outbox plus approval-gated live delivery, and the exact discord tool covers upstream core REST actions. The official Hermes platform list, gateway lifecycle, admin actions, and slash parity are still not identical.',
