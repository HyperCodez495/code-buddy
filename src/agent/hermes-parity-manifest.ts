...
const FEATURES: HermesParityFeature[] = [
  ...
  },
  {
    ...
    codeBuddyEvidence: ['src/skills/', 'src/agent/research-script-skill-candidate.ts', 'docs/hermes-agent-status.md'],
    status: 'partial',
    verificationCommands: ['npx tsx src/index.ts skills list --json'],
    notes: 'Native skill coverage is good, but exact Hermes hub/tap/update/reset/trust behavior is not proven identical.',
    nextWork: 'Expose a skill package manager panel in Cowork.',
  },
  {
