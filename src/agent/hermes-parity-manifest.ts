...
const FEATURES: HermesParityFeature[] = [
  ...
  },
  {
    ...
    notes: 'Code Buddy has many native tools and now exact Kanban, send_message, discord core, Home Assistant REST, Spotify, x_search, Feishu document/comment, mixture_of_agents, execute_code, vision_analyze, browser_vision, text_to_speech, image_generate, video_analyze, and video_generate tool names, but not all official third-party integrations.',
