...
const FEATURES: HermesParityFeature[] = [
  ...
  },
  {
    ...
    verificationCommands: [
      ...
      'npm test -- tests/tools/execute-code-real.test.ts tests/tools/send-message-real.test.ts tests/tools/discord-tool-real.test.ts tests/tools/homeassistant-tool-real.test.ts tests/tools/mixture-of-agents-real.test.ts tests/tools/spotify-tool-real.test.ts tests/tools/kanban-real.test.ts tests/tools/vision-analyze-real.test.ts tests/tools/text-to-speech-real.test.ts --run',
    ],
    notes: 'Code Buddy has many native tools and now exact Kanban, send_message, discord core, Home Assistant REST, Spotify, mixture_of_agents, execute_code, vision_analyze, browser_vision, and text_to_speech tool names, but not all official third-party integrations.',
