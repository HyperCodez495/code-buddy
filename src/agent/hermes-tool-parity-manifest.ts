...
const OFFICIAL_HERMES_TOOLS: HermesOfficialToolReference[] = [
  ...
  },
  {
    ...
    category: 'skills',
    officialSource: OFFICIAL_SOURCE_TOOLSETS,
    equivalentCodeBuddyTools: ['skill_discover'],
    equivalenceStatus: 'partial',
    notes: 'Code Buddy can discover skills, but Hermes exposes a direct skill inventory tool.',
    nextWork: 'Expose read-only installed skill listing as an LLM tool if agent-managed skills stay in scope.',
  },
  {
    name: 'skill_view',
    toolset: 'hermes-core',
    ...
    equivalentCodeBuddyTools: ['skill_discover'],
    equivalenceStatus: 'partial',
    notes: 'Code Buddy can discover skill metadata; direct skill content viewing is not exposed as the same tool.',
  },
  {
    name: 'skill_manage',
    toolset: 'hermes-core',
