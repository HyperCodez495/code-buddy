...
export function ConfigModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-md">
      <div className="flex max-h-[88vh] w-full max-w-[1040px] flex-col overflow-hidden rounded-[2rem] border border-border-subtle bg-background shadow-elevated mx-4">
