/**
 * SlackConfigStep — Slack app credentials (Socket Mode) and DM policy configuration
 */
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4">
        ...
        <div>
          ...
          />
          <p className="text-xs text-text-muted mt-1">{t('remote.slackAppTokenHint')}</p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="••••••••••••••••"
          />
          <p className="text-xs text-text-muted mt-1">{t('remote.slackSigningSecretHint')}</p>
        </div>
