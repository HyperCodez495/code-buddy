...
- [ ] **Implement review-gated `skill_manage` lifecycle**
  ...
  - Remaining scope: expose installed-skill patch controls in Cowork and optionally add remote hub release diff previews.
  ...
  - Acceptance:
    ...
    - Remaining: expose installed-skill patch controls in Cowork.
