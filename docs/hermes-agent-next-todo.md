...
- [ ] **Implement review-gated `skill_manage` lifecycle**
  ...
  - Remaining scope: expose installed-skill patch/rollback/update/delete controls in Cowork and optionally add remote hub release diff previews.
  ...
  - Acceptance:
    ...
    - Remaining: expose installed-skill patch/rollback/update/delete controls in Cowork.
...
- [ ] **Build a Cowork Skill Package Manager panel**
  ...
  - Remaining scope: turn the strips into a full panel with expanded side-by-side SKILL.md diff and installed-skill patch/rollback/update/delete actions.
  - Acceptance:
