...
- [x] **Implement review-gated `skill_manage` lifecycle**
  ...
  - Remaining scope: optionally add reset behavior.
  ...
  - Acceptance:
    ...
    - Remaining product polish: add reset behavior for installed skills when a hub backend is configured.
...
1. Remaining skills polish: reset behavior for installed skills.
