...
- Exact `skill_manage` prompt-tool parity is closed; repository tap/trust management is now a real persisted CLI surface, while direct GitHub/well-known tap discovery and remote release diff previews remain only partially proven.
