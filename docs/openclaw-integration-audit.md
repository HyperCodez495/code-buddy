...
4. Continue hardening Code Buddy Fleet as the main robot brain:
   ...
   visibility.
5. Add a separate approved outbound reply workflow after Fleet results
   are reviewed locally. It must keep approval visible and must not
   silently dispatch channel replies.
