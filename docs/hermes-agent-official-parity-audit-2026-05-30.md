...
2. Close the remaining user-facing gaps first: provider/model setup clarity and
   Cowork screens for the active Hermes/Fleet toolset. CLI JSON provider/model
   readiness is now available through `buddy hermes doctor --json`.
